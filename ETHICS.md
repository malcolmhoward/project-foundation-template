...
This ethical framework applies at different levels depending on the project's relationship to PFT:

#### Tier 1: Core Components (Ethical Review REQUIRED)

Full ethical review process (Principle Zero test + Ethical Pause + documented mitigations) is **required** for:

- **Project Foundation Template itself** - The source template
- **Decoupled governance modules** - Principles/procedures extracted into separate repositories but maintained by PFT maintainers
- **Core extensions** - Plugins or features intended to be distributed as part of PFT
...
- **All instances generated by the template** - Projects that run the generator
...
Ethical review process is **at project discretion** for:

- **Coordination layers built using this template** - Meta-projects that orchestrate other projects
- **Documentation-focused projects** - Projects primarily producing guides, tutorials, or reference materials
- **Community resources** - Build journals, hardware guides, getting-started documentation

These projects should:
- Inherit Principle Zero as a guiding philosophy
- Include ethical considerations in their PR templates
- Apply common-sense harm prevention
...
|------|---------------|----------------|--------------|
| Core Components | Code/templates users deploy | Medium-High | Full review required |
| Generated Instances | Deployed governance files | Medium | Strong recommendation |
...
|---------|------|---------|
| 1.1.0 | 2026-01-25 | Added Ethical Review Process section; clarified ecosystem tiers and ethical review requirements |
